<template>
  ...
  const current = ref<string[]>(['time2']);
  ...
  const data = [
    {
      ...
      scen_test1:'2020-03-16~2021-06-20',
      produce:'2020-03-16~2021-06-20',
      is_base:'是'
    },
    {
      key: '1',
  ...
  // ];
    ...
    gantt.parse({
              data: [
                  ...
                  { id: 2, text: "硬件设计实现", start_date: "01-04-2023", duration: 5, progress: 0.6, parent: 1 },
                  { id: 3, text: "最小系统回版", start_date: "06-04-2023", duration: 15, progress: 0.6, parent: 1 },
                  { id: 4, text: "硬件--验收测试", start_date: "21-04-2023", duration: 20, progress: 0.6, parent: 1 },
                  { id: 5, text: "硬件--板测试", start_date: "12-05-2023", duration: 10, progress: 0.6, parent: 1 },
                  { id: 6, text: "硬件--板问题解决到二板投板", start_date: "15-05-2023", duration: 10, progress: 0.6, parent: 1 },
                  { id: 7, text: "二板测试", start_date: "20-05-2023", duration: 10, progress: 0.6, parent: 1 },
                  { id: 8, text: "试生产", start_date: "25-05-2023", duration: 10, progress: 0.6, parent: 1 },
  
          { id: 9, text: "项目2", start_date: "01-04-2023", duration: 80, progress: 0.4, open: true },
                  { id: 10, text: "硬件设计实现", start_date: "01-04-2023", duration: 5, progress: 0.6, parent: 9 },
                  { id: 11, text: "最小系统回版", start_date: "06-04-2023", duration: 15, progress: 0.6, parent: 9 },
                  { id: 12, text: "硬件--验收测试", start_date: "21-04-2023", duration: 20, progress: 0.6, parent: 9 },
                  { id: 13, text: "硬件--板测试", start_date: "12-05-2023", duration: 10, progress: 0.6, parent: 9 },
                  { id: 14, text: "硬件--板问题解决到二板投板", start_date: "15-05-2023", duration: 10, progress: 0.6, parent: 9 },
                  { id: 15, text: "二板测试", start_date: "20-05-2023", duration: 10, progress: 0.6, parent: 9 },
                  { id: 16, text: "试生产", start_date: "25-05-2023", duration: 10, progress: 0.6, parent: 9 },
              ],
              links: [
